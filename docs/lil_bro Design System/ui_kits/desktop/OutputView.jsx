  ...
  return (
    <div className="main-area">
      <div className="main-header">
        <div className="main-title">Pipeline Output</div>
        ...
        <div className="dlg-body" style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
          ...
          <div>
            <div style={{ fontSize: '0.9rem', fontWeight: 500, color: 'var(--text-primary)', marginBottom: 6 }}>
              <span style={{ color: '#e8e6e3' }}>lil<span style={{ color: '#00e5cc' }}>_</span>bro</span> will create a Windows System Restore Point
            </div>
