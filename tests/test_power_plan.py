...
@patch('src.agent_tools.power_plan.get_active_power_plan')
...
@patch('src.agent_tools.power_plan.prompt_approval')
...
@patch('src.agent_tools.power_plan.get_active_power_plan')
@patch('src.agent_tools.power_plan.list_available_plans')
@patch('src.agent_tools.power_plan.create_high_performance_plan')
@patch('src.agent_tools.power_plan.prompt_approval')
@patch('src.agent_tools.power_plan.set_active_plan')
