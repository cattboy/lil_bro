...
@patch('src.agent_tools.rebar.subprocess.run')
...
@patch('src.agent_tools.rebar.wmi.WMI')
...
@patch('src.agent_tools.rebar.check_nvidia_rebar')
@patch('src.agent_tools.rebar.check_wmi_rebar')
