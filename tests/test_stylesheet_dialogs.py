"""Exercises every QSS builder in ``stylesheet_dialogs`` against the real palette.
...
BUILDERS = [
    (_qss_output_header, "QFrame#outputHeader"),
    (_qss_batch_dialog, "QDialog#batchDialog"),
    (_qss_card_dialog, "QDialog#cardDialog"),
    (_qss_splash, "QDialog#splashDialog"),
]
